...
#     met_long=met_long_right
  ...
  mets = getMets(met_index,NA,level, rxn_index, met, rxn_long, rxn_ss, met_short, met_long)
  
  return(list("metabolites"=mets$metabolites, "matrix"=model$S[met_index, rxn_index], "rxns"=rxn_index, "mets"=met_index))
