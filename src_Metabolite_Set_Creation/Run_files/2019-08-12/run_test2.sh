...
qsub -l h_rt=01:00:00 -l h_vmem=20G -N Crossomics_BuildMetabSet -t 1-50 -o /home/cog/$USER/Crossomics/logs -e /home/cog/$USER/Crossomics/logs -m bea -M "m.h.p.kerkhofs-7@umcutrecht.nl" $code_dir/extend_test2.sh
