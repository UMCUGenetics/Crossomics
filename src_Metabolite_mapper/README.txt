...
All excel files used for these scripts must be converted to .RData and .RDS files. This is to ensure the scripts can work without any java-dependencies, make it easier to be HPC-compatible and to improve the speed of the scripts.


PIPELINE HIERARCHY/STRUCTURE:

The main script is GeneMetaboliteMapper.R. Scripts used by the main script are in the Supportive folder and are: MSEA.R and sourceDir.R.
