...
cat("
    Copied from 'GeneMetaboliteMapper_ME.R' in the Metab/Metabolomics/DIMS_pipeline/R_workspace_ME/Crossomics/Crossomics_SinglePatients/src folder
...
p.values.assi.pos = getPvalues(peaklist = outlist.pos.stats.more, 
                               ...
                               patients,
                               controls,
                               adducts = FALSE) # assi.hmdb, HMDB_code For new identification !!!!!!!!!!!!!!!!!!!!!!!!!!
