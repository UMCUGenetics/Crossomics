...
do 
    ...
    qsub -l h_rt=00:20:00 -l h_vmem=1G -N Crossomics_MetabMapper -wd $core_dump_dir -t 1-4 -o /home/cog/$USER/Crossomics_HPC/logs -e /home/cog/$USER/Crossomics_HPC/logs -m bea -M "m.h.p.kerkhofs-7@umcutrecht.nl" $code_dir/run_R.sh $thresholds $maxrxns $steps $code_dir $seed_file $R_location
