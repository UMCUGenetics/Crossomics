...
This repository is for all Crossomics related scripts. The main script (for now) is GeneMetaboliteMapper_Marten_AdductSums.R, which is copied and modified from the similarly named .R files. 
